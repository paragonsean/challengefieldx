...
//		            'label'     => esc_html__( 'Select variants fonts', 'eduma' ),
//		            'tooltip'  => esc_html__( 'Allows you to select multiple variants for font body and headings', 'eduma' ),
//		            'description'  => esc_html__( 'Allows you to select multiple variants for font body and headings', 'eduma' ),
//		            'type'      => 'select',
//		            'multiple'      => 999,
//		            'priority'    => 10,
