...
<div class="<?php echo esc_attr( $class ); ?>">
	<div class="<?php echo esc_attr( $class_inner ); ?>">
		<?php
		require_once THIM_EKIT_PLUGIN_PATH . 'inc/elementor/widgets/global/course-base/course-base.php';
		require_once THIM_EKIT_PLUGIN_PATH . '/inc/elementor/widgets/global/list-course/list-course.php';
